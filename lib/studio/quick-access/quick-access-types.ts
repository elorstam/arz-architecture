...
export type StudioQuickAccessItem={key:string;entityType:StudioFavoriteEntityType;entityId:string;title:string;subtitle:string;url:string;isFavorite:boolean;lastOpenedAt?:string;thumbnailUrl?:string};
