...
export type StudioSearchResult={id:string;provider:string;category:StudioSearchCategory;categoryLabel:string;icon:string;title:string;subtitle:string;breadcrumb:string;badge:string;url:string;searchText:string;isFavorite?:boolean};
