...
export default async function ProjectDetailPage({params}:{params:Promise<{projectId:string}>}){
 ...
 return <section className="mx-auto min-w-0 max-w-[1540px] px-4 py-6 sm:px-6 sm:py-8 lg:px-8 lg:py-9"><StudioProjectDetailHeader project={project}/><StudioEntityTags entityType="project" entityId={project.id}/><StudioProjectTabs projectId={project.id}/><StudioOfficialProcessSummary projectId={project.id}/><StudioProjectOverview project={project}/></section>;
}
