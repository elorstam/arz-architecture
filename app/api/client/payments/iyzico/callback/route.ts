...
export async function POST(request:Request){
 ...
 try{
  ...
  await finalizeAttempt(attempt.id,String(result.paymentId),String(attempt.amount),attempt.currency,config.environment);return NextResponse.redirect(destination("success"),303);
