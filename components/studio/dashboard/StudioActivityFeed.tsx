      ...
      <div className="px-5 py-1">
        {items.map((item, index) => (
          <article key={`${item.project}-${item.event}`} className="relative flex gap-3 py-4">
            ...
            <span className="studio-dashboard-activity-icon relative z-10 grid h-9 w-9 shrink-0 place-items-center rounded-xl bg-[#eaf1f6] text-[#55798c]"><StudioIcon name="activity" className="h-4 w-4" /></span>
