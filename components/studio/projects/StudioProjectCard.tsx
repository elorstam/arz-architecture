...
export default function StudioProjectCard({project}: {project: StudioProject}) {
  return (
    <article className="group min-w-0 overflow-hidden rounded-xl border border-[#dedad1] bg-white shadow-[0_4px_18px_rgba(32,39,46,.03)] transition-[border-color,box-shadow,transform] duration-200 hover:-translate-y-0.5 hover:border-[#cfc7b7] hover:shadow-[0_12px_30px_rgba(32,39,46,.065)]">
      <Link href={`/studio/projects/${project.id}`} className="block outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-[#9e8452]">
